...
public class MovieFactory {
    ...
    public static List<Movie> getMoviesToSeeList() {
        ...
        movieList.add(new Movie("51 variations", "Peronne n'aurait pu préparer Tiantian à ce qui va lui arriver. Muni de son Audi et sa cravate, il se lance à coprs perdu dans le combat de sa vie.", Color.GRAY));
